...
──────────────
Slash commands:
  /configure-visibility <mode>  — set per-guild private/public responses
  /configure-responses  <type>  — set per-guild plain/embed responses
  /whitelist-view <scope>       — view server or global whitelist
"""
...
class WhitelistPaginatorView(discord.ui.View):
    ...
    def _build_content(self) -> str:
        ...
        lines = [f"**{self._title}**"] + [f"- {e}" for e in page_entries]
...
class ConfigCog(commands.Cog, name="Config"):
    ...
    async def whitelist_view(
        ...
        if scope.value == "global":
            ...
            title = f"Server Whitelisted Words"
